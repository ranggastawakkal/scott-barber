...
<head>
    ...
    <title>Scott Barber | @yield('title')</title>
    ...
    <link rel="stylesheet" type="text/css" href="https://datatables.net/release-datatables/media/css/dataTables.bootstrap4.css" />
